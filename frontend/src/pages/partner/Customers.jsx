          ...
          {filteredCustomers.map((customer) => (
            ...
            >
              <div className="flex justify-between items-start mb-3">
                ...
                <span
                  className={`px-2 py-1 text-xs leading-5 font-semibold rounded-full ${getFrequencyBadgeColor(
                    customer.frequency
                  )} ml-2 flex-shrink-0`}
                >
                  {customer.frequency}
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredCustomers.map((customer) => (
                  <tr key={customer.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getFrequencyBadgeColor(
                          customer.frequency
                        )}`}
                      >
                        {customer.frequency}
