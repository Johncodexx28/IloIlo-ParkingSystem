    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-3 items-center">
          <span className="px-3 py-1 bg-green-500 text-white text-sm rounded-full">System Healthy</span>
      ...
      <div className="grid grid-cols-4 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
          ...
          <div className="text-3xl font-bold text-gray-900 mb-1">{systemStats.uptime}</div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
          ...
          <div className="text-3xl font-bold text-gray-900 mb-1">{systemStats.totalDevices}</div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
          ...
          <div className="text-3xl font-bold text-green-600 mb-1">{systemStats.onlineDevices}</div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
          ...
          <div className="text-3xl font-bold text-red-600 mb-1">{systemStats.offlineDevices}</div>
      ...
      <div className="grid grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100">
          <div className="p-6 border-b border-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-1">Device Status by Type</h2>
            <p className="text-gray-600 text-sm">Health status of different device categories</p>
          </div>
          <div className="p-6">
            {deviceTypes.map((device, index) => (
              <div key={index} className="flex items-center justify-between py-4 border-b border-gray-50 last:border-b-0">
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <div>
                    <div className="font-medium text-gray-900">{device.name}</div>
                    <div className="text-sm text-gray-500">{device.online} online</div>
                  </div>
                </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100">
          <div className="p-6 border-b border-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-1">Network Status</h2>
            <p className="text-gray-600 text-sm">Connectivity and performance metrics</p>
          </div>
          <div className="p-6">
            {networkStatus.map((network, index) => (
              <div key={index} className="flex items-center justify-between py-4 border-b border-gray-50 last:border-b-0">
                <div className="flex items-center gap-3">
                  <div className={`w-2 h-2 rounded-full ${getStatusDot(network.status)}`}></div>
                  <div>
                    <div className="font-medium text-gray-900">{network.name}</div>
                    <div className={`text-sm ${getStatusColor(network.status)}`}>{network.status}</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm text-gray-900">Latency: {network.latency}</div>
                  <div className="text-sm text-gray-500">Bandwidth: {network.bandwidth}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100">
        <div className="p-6 border-b border-gray-100">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-1">System Alerts</h2>
              <p className="text-gray-600 text-sm">Recent alerts and system notifications</p>
            </div>
            <div className="flex gap-3 items-center">
