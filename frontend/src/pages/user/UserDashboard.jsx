    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">Here's what's happening with your parking today.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-gray-600 text-sm font-medium">Favorite Spots</h3>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            <div className="p-6 border-b border-gray-100">
              <h2 className="text-xl font-semibold text-gray-900">Current Parking</h2>
              <p className="text-gray-600 text-sm mt-1">Your active parking sessions</p>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="border border-green-200 rounded-lg p-4 bg-green-50 relative">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-gray-900 text-lg">SM City Iloilo - Main Parking</h3>
              ...
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-gray-600 mb-4">No other active parking sessions</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            <div className="p-6 border-b border-gray-100 flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-600 text-sm mt-1">Your latest parking history</p>
              </div>
            ...
            <div className="divide-y divide-gray-100">
              {recentBookings.map((booking) => (
                <div key={booking.id} className="p-6 flex items-center justify-between hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-4">
                    <div className={`w-3 h-3 rounded-full ${booking.status === 'active' ? 'bg-green-500' : 'bg-gray-400'}`}></div>
                    <div>
